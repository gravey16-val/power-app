...
## Goal
Full Docker Compose stack (frontend, backend, db) is running locally with a passing health endpoint, migrations, env var wiring, and CI-ready test harnesses for both frontend and backend.
